    ...
    <div style={{
      ...
      <style>{`
        ...
        @media (min-width: 769px) and (max-width: 1024px) {
          .confirmCard { padding: 42px 36px !important; max-width: 460px !important; }
        }
        @media (max-width: 768px) {
          .confirmCard { padding: 36px 28px !important; }
        }
        @media (max-width: 480px) {
          .confirmCard { padding: 28px 18px !important; border-radius: 18px !important; }
        }
      `}</style>
